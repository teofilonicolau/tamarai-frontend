// src/components/Previdenciario/AposentadoriaInvalidezForm.jsx
...
import { validators } from '../../utils/validations'; // <-- IMPORTA A VALIDAÇÃO DE CPF
import Preview from '../FormularioDinamico/Preview';

const AposentadoriaInvalidezForm = () => {
  ...
  const onSubmit = async (raw) => {
    ...
    try {
      ...
      const payload = normalizePayload({
        ...
        nome: raw.nome?.trim() || '',
        cpf, // já tem 11 dígitos + validado
        rg: raw.rg || '',
        ...
        laudos_medicos: laudos.length > 0 ? laudos : [], // array vazio ao invés de null
      ...
      const endpoint = ENDPOINTS?.previdenciario?.peticao_aposentadoria_invalidez;
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-xl">
      <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
        Petição Inicial - Aposentadoria por Invalidez
      </h3>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <input type="hidden" value="Aposentadoria por Invalidez" {...register('tipo_beneficio')} />
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
 Rä             <label className="block text-sm font-medium mb-1">CPF * (11 dígitos)</label>
              <input
                {...register('cpf', {
                  required: 'CPF obrigatório',
                  pattern: { value: /^\d{11}$/, message: 'Apenas números (11 dígitos)' }
                })}
                maxLength={11}
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" {...register('tempo_contribuicao_total')} placeholder="Ex.: 25" className="w-full px-4 py-2 border rounded-md" />
            </div>
            <div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-10">
          <button
            type="submit"
            disabled={loading}
            className="flex-1 bg-gradient-to-r from-blue-600 to-blue-800 text-white py-4 rounded-lg hover:from-blue-700 hover:to-blue-900 disabled:opacity-60 transition font-bold text-xl shadow-lg hover:shadow-xl"
          >
...
export default AposentadoriaInvalidezForm;